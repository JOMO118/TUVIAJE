    ...
    public function send_email($email, $fecha, $hora){
        ...
        try {
            ...
            <div class="card" style="width: 18rem;">
                <div class="card-body">
                  <h5 class="card-title">Solicitud reserva</h5>
                  <p class="card-text">Señor(a) guia turistico usted tiene una solicitud de reserva para el dia '.$fecha.' y hora'.$hora.' por favor confirmar <b>atentamente TUVIAJE</b></p>
                  <a href="#" class="btn btn-primary">Ir a TUVIAJE</a>
                </div>
            </div>
